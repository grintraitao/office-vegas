    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div>
        ...
        <div class="flex items-center gap-2">
          <div class="text-3xl w-12 h-12 flex items-center justify-center bg-gray-100 rounded-lg">
            {{ form.icon }}
          </div>
          <div class="flex flex-wrap gap-1">
            <button
              ...
              type="button"
              :class="[
                'text-xl p-1 rounded hover:bg-gray-100',
      ...
      <!-- Name -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Tên phần thưởng</label>
      ...
      <!-- Cost -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Giá (coins)</label>
      ...
      <div>
        <label class="flex items-center gap-2">
          ...
          <span class="text-sm font-medium text-gray-700">Giới hạn số lượng</span>
        </label>
        <Input
          v-if="form.hasStock"
